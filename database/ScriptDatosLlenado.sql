...
insert into TarjetaDebito values ('TRJTID_001',5496321548563714,5489);
insert into TarjetaDebito values ('TRJTID_002',4812384564589123,4864);
insert into TarjetaDebito values ('TRJTID_003',6894532185464321,1548);
insert into TarjetaDebito values ('TRJTID_004',5486513518651348,6178);
insert into TarjetaDebito values ('TRJTID_005',6578523171153416,2948);	
